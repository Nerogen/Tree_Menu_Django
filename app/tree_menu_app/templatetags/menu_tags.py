...
def draw_menu(context, menu_name: str):
    """ get all parents and current link from MenuItem model """
...
def _render_menu(menu_items: MenuItem, current_path: str) -> str:
    """ this function make tree structure with <ul> and <li> html tags
    and set active class to some button of menu"""
    menu_html: str = '<ul>'
